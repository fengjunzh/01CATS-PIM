...
<System.Runtime.InteropServices.ProgId("clsOperatorInterface_NET.clsOperatorInterface")> Public Class clsOperatorInterface
	...
	Private Sub UpdateCaption(ByVal swName As String)
		...
		frmMain.Text = String.Format("CommScope Heliax Test Software – {0} (Ver. {1} )", swName, Common.SW_Version)
	End Sub
	...
	WriteOnly Property ModeName() As String
		...
		End Set
	End Property
	WriteOnly Property CycleTime As Decimal
		Set(value As Decimal)
			If frmMain IsNot Nothing Then frmMain.lblTestTime.Text = Math.Round(value, 2)
		End Set
	End Property
