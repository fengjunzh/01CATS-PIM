...
Private Sub runStopButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles runStopButton.Click
    ...
    Try
        ...
        If unsavedResults Then
            saveMsg = "You have unsaved data." & vbCrLf & _
                      "If you run another loop test, this data will be lost." & vbCrLf & _
    ...
    '                addResult "Test Iteration " & count, "", "", "", True
                        ...
                        Else
                            Call TestObj.RunTest(frmMain.TxtBarcode.Text, Replace(testStep, "Invalid_", ""), Cancel)
                        End If
                    End If
            End While
        Else
    ...
    '                addResult "Test Iteration " & count, "", "", "", True
                        iterStartTime = Now()
                        If TestObj Is Nothing Then
                            Common.clsOperator.REvntRunTest(frmMain.TxtBarcode.Text, Replace(testStep, "Invalid_", ""), Cancel)
                        Else
...
Private Sub CancelAction()
    ...
    If unsavedResults Then
        saveMsg = "You have unsaved data." & vbCrLf & _
                  "If you exit now, this data will be lost." & vbCrLf & _
