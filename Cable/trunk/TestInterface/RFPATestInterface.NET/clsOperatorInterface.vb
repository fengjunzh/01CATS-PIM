...
<System.Runtime.InteropServices.ProgId("clsOperatorInterface_NET.clsOperatorInterface")> Public Class clsOperatorInterface
    ...
    ReadOnly Property Factory() As String
        ...
        End Get
    End Property
    WriteOnly Property TestLength_m() As Decimal
        Set(value As Decimal)
            Common.TestLength_m = value
            frmMain.lblTestLength.Text = value.ToString & "/" & (value * 3.281).ToString
        End Set
    End Property
	...
	WriteOnly Property Plant() As String
		Set(value As String)
			If frmMain IsNot Nothing Then frmMain.tsslPlant.Text = "Plant: " & value
		End Set
	End Property
	Public ReadOnly Property LogMessage() As String
		...
		End Get
	End Property
	WriteOnly Property DB() As String
		Set(value As String)
			If frmMain IsNot Nothing Then frmMain.tsslDb.Text = "DB: " & value
		End Set
	End Property
