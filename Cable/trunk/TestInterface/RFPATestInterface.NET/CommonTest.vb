...
Module Common
  ...
  Public Globals_Renamed As New clsGlobals
    ...
    Public NewCable As Cable
    Public DbCable As Cable
    Public phaseExtendCable As frmNewCable.MeasPhaseExtendCable
    Public TestLength_m As Decimal
    Public gAppPath As String = "c:\cats\"
    Public gTestSystemPath As String = gAppPath & "test_system\"
