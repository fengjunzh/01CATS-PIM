...
Public Class TestReport
	Public Class XmlFramework
        ...
        Public Class TPhase
            ...
            <XmlElement("PhaseExtendCable")>
            Public PhaseExtendCable As New PhaseExtendCable

            <XmlElement("TestGroup")>
            Public TestGroups As New List(Of TGroup)
        End Class

        Public Class PhaseExtendCable
            Public TestConnector As String
            Public TestLengthM As Decimal
            Public TemperatureC As Decimal
