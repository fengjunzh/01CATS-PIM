...
<System.Runtime.InteropServices.ProgId("clsOperatorInterface_NET.clsOperatorInterface")> Public Class clsOperatorInterface
	...
	ReadOnly Property mainTop() As Integer
		...
		End Get
	End Property
	WriteOnly Property EnableTimer() As Boolean
		Set(value As Boolean)
			frmMain.tmOpcWatch.Enabled = value
		End Set
	End Property
	...
	Public WriteOnly Property MiiStatus() As Boolean
		...
		End Set
	End Property
	Public WriteOnly Property Automation() As Boolean
		Set(ByVal Value As Boolean)
			frmMain.tsslAuto.Text = String.Format("Automation: {0}", IIf(Value, "ON", "OFF"))
		End Set
	End Property
