...
Friend Class frmMain
    ...
    Private Sub RunAllTest()
        ...
        End With
        '获取Common.Testset_ID（PC名）和Common.Location
        ...
        End If
        '因PreTest过程没有对Cancel赋值，所以Cancel = False，下面语句不会执行
        If Cancel Then
        ...
        If TestObj Is Nothing Then
            Common.clsOperator.REvntRunTest(Me.txtSN1.Text, Replace(TestStep, "Invalid_", ""), Cancel)
        Else
        ...
        If (pResults.GetFailures() + pResults.GetPasses) > 0 Then
            ...
            If TestStat = "PASS" Then SetStepStatus(TestStep, 2) : TestObj.WritePlcAsync()
...
ErrorHandler:
    ...
    Private Sub frmMain_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
        ...
        txtSN1.Focus()
        txtSN1.Select()
        tmOpcWatch.Enabled = True
        tmOpcWatch.Enabled = False
    End Sub
    ...
    '    If txtSN1.Text.Length = 7 OrElse txtSN1.Text.Length = 13 OrElse txtSN1.Text.ToUpper.Trim = gLowPimLoadTestSn Then
    ...
    '                            txtSN2.SelectAll()
    '                        Else
    '                            TestObj.LoadPimTestData(cableAssembly1.SerialNumber, cableAssembly1.PartNumber, clsOperator.SelectedTestPhase)
    ...
    Private Sub tmOpcWatch_Tick(sender As Object, e As EventArgs) Handles tmOpcWatch.Tick
        Try
            TestObj.ReadPlcAsync()
        Catch ex As Exception
            tmOpcWatch.Enabled = False
            Throw New Exception("tmOpcWatch_Tick()::" & vbCrLf & ex.Message)
        End Try
    End Sub
End Class