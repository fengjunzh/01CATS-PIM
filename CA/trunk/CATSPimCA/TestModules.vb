...
#End If
    ...
    Public Function InitPimInstrument(phase As TestSpec.TestPhase) As Boolean
        Try
...
#End If
            ...
            Return True
        Catch ex As Exception
            Throw New Exception("InitPimInstrument()::" & ex.Message)
        End Try
    End Function
    Public Function RunTestPhase(phase As TestSpec.TestPhase) As Boolean
