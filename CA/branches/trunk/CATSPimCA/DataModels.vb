Public Class DataModels
	...
	Public Class RTimePara
        ...
        Public two_sn_exist As Boolean
	...
	Public Class TestTrace
        ...
        Public StsB As New Dictionary(Of String, List(Of FrequencyPoint))
        Public StsC As New Dictionary(Of String, List(Of FrequencyPoint))
