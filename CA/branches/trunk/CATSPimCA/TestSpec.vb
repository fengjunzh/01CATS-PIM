...
Public Class TestSpec
    ...
    Public Sub New(ByVal cq_modes As CATS.Model.cq_modes)
        ...
        Catch ex As Exception
            Throw New Exception("TestSpec.TestPhase.New()::" & ex.Message)
        End Try
    End Sub
    '<Serializable()>
    ...
    Public Class TestItem
        ...
        Public Sub New(cq_spec_imd_details As CATS.Model.cq_spec_imd_details)
            ...
            'Dim cfg_imd_mainModel As CATS.Model.cfg_imd_main
            'Dim cfg_imd_mainManager As New CATS.BLL.cfg_imd_mainManager
            'Dim stsDescription As String = cq_spec_imd_details.cfg_imd_main.descr

            'cfg_imd_mainModel = cfg_imd_mainManager.SelectByDescr(stsDescription.Replace(stsDescription.Substring(6, 4), "900"))
            'MyBase.cfg_imd_main = cfg_imd_mainModel
