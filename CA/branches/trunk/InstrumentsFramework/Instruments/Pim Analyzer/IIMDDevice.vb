Public Interface IIMDDevice
	...
	Property PointInUpSweepTrace() As Boolean
	...
	Sub SetPIMFreqMHz(ByVal freqMHzIM As Double)
	...
	'Function GetRFPower(ByVal Port As enumRFPORTS) As Decimal
	Function GetRFPower() As Double()
	...
	Function GetDTP_Time(Accurate As String, speed As String) As String
	Sub DTF_Cal()

	Function CheckPowerVersion(ByVal PowerDBM1 As Double) As Boolean

	Property DeviceCheckOK() As Boolean

	Function SwitchUpAndDown(ByVal SweepMode As Boolean) As Boolean
