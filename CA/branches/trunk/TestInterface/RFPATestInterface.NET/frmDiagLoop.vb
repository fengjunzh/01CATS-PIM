    ...
    Private Sub runStopButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles runStopButton.Click
        ...
        Try
            ...
            If TestObj Is Nothing Then
                Common.GUI.REvntPreTest(Replace(testStep, "Invalid_", ""), tmpBarcode, Cancel)
            Else
            ...
            If tmpBarcode = "" Then
                If Not frmMain.GetUUTInfo2() Then
                    ...
                    Exit Sub
                End If
                tmpBarcode = frmMain.txtSN1.Text
            Else
                frmMain.txtSN1.Text = tmpBarcode
            End If
            ...
            If runForever Then
                While Not stopTest And Not abortNow
                    ...
                    If Not stopTest And Not abortNow Then
                        ...
                        iterStartTime = Now()
                        If TestObj Is Nothing Then
                            Common.GUI.REvntRunTest(tmpBarcode, Replace(testStep, "Invalid_", ""), Cancel)
                        Else
                            Call TestObj.RunTest(frmMain.txtSN1.Text, Replace(testStep, "Invalid_", ""), Cancel)
                        End If
                    End If
                End While
            Else
                While count < runCount And Not stopTest And Not abortNow
                    ...
                    If Not stopTest And Not abortNow Then
                        ...
                        iterStartTime = Now()
                        If TestObj Is Nothing Then
                            Common.GUI.REvntRunTest(frmMain.txtSN1.Text, Replace(testStep, "Invalid_", ""), Cancel)
                        Else
