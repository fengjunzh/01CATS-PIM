...
Friend Class clsTestPlan
	...
	Public Sub InitializeGui()
		...
		Dim ps() As String = {"FinalTest", "PreTest", "Cold", "Heat", "11111", "33333", "44444", "55555", "66666", "77777", "88888", "99999", "00000"}
		GUI.DefinePhaseStationMenu(ps)
	...
	Private Sub ITestPlan_PreTest(ByVal TestPhase As String, ByRef Barcode As String, ByRef Cancel As Boolean) Implements RFPATestInterface.ITestPlan.PreTest
	...
	Private Sub ITestPlan_RunTest(ByVal Barcode As String, ByVal TestPhase As String, ByRef Cancel As Boolean) Implements RFPATestInterface.ITestPlan.RunTest
		...
		Try
			...
			Select Case TestPhase
				...
				Case "PostBurnin"
					...
					Call GUI.StopTestGroup()
				Case Else
					Call MsgBox("Invalid testphase: " & TestPhase, MsgBoxStyle.Critical, "Error")
					Exit Sub
			End Select
	...
	Public Sub MenuPhaseStation(PhaseStation As Object) Implements ITestPlan.MenuPhaseStation
