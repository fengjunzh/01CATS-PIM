...
<System.Runtime.InteropServices.ProgId("clsOperatorInterface_NET.clsOperatorInterface")> Public Class clsOperatorInterface
	...
	Public Event RunTest(ByVal Barcode As String, ByVal TestPhase As List(Of String), ByVal Cancel As Boolean)
	Public Event RunTestGroup(ByVal TestGroup As String, ByVal Barcode As String, ByVal TestPhase As String)
	Public Event PreTest(ByVal TestPhase As List(Of String), ByVal Barcode As String, ByVal Cancel As Boolean)
	...
	Friend Sub REvntRunTest(ByVal Barcode As String, ByVal TestPhase As List(Of String), ByVal Cancel As Boolean)
	...
	Friend Sub REvntPreTest(ByVal TestPhase As List(Of String), ByVal Barcode As String, ByVal Cancel As Boolean)
	...
	WriteOnly Property ModeName() As String
		...
		End Set
	End Property
	WriteOnly Property CalButtonVisable() As Boolean
		Set(value As Boolean)
			If frmMain IsNot Nothing Then frmMain.CmdCAL.Visible = value
		End Set
	End Property
	...
	Public Sub DefineTestStepsAry(ByVal TestSteps() As String)
		...
		With frmMain.LstTestStep
			...
			For Each name In TestSteps
				...
				'End If
				progID = name
				.Rows(.Rows.Add()).Cells(1).Value = progID
				'	.Rows(.Rows.Count - 1).Cells(1).Value = progID
	...
	'  If frmMain.InvokeRequired Then
	'    frmMain.Invoke(New Action(Of String, Double, Double, Double)(AddressOf RecordResultSync), Testname, measured, Low, High)
	'  Else
	'    RecordResultSync(Testname, measured, Low, High)
	'  End If
	'End Function
	Public Function RecordResult(ByVal Testname As String, ByVal measured As Double, ByVal Low As Double, ByVal High As Double) As Boolean
		Dim pass As Boolean
		...
		DisplayNumericResult(Testname, Low, measured, High, pass)
	...
	Public Sub DisplayNumericResult(ByVal Test As String, ByVal Low As Double, ByVal measured As Double, ByVal High As Double, ByVal Passed As Boolean)
		If frmMain.InvokeRequired Then
			frmMain.BeginInvoke(New Action(Of String, Double, Double, Double, Boolean)(AddressOf DisplayNumericResult), Test, Low, measured, High, Passed)
		Else
			frmMain.DisplayNumericResult(Test, Low, measured, High, Passed)
		End If
	End Sub

	'Public Sub RecordStringResult(ByVal Testname As String, ByVal measured As String, Optional ByVal MatchString As String = "*")
	'  If frmMain.InvokeRequired Then
	'    frmMain.Invoke(New Action(Of String, String, String)(AddressOf RecordStringResultSync), Testname, measured, MatchString)
	'  Else
	'    RecordStringResultSync(Testname, measured, MatchString)
	'  End If
	'End Sub
	Public Sub RecordStringResult(ByVal Testname As String, ByVal measured As String, Optional ByVal MatchString As String = "*")
		Dim pass As Boolean
		...
		DisplayStringResult(Testname, "NA", measured, "NA", pass)
		Call Globals_Renamed.MyDoEvents() 'to check abort flag
	End Sub
	Private Sub DisplayStringResult(ByVal Test As String, ByVal Low As String, ByVal measured As String, ByVal High As String, ByVal Passed As Boolean)
		If frmMain.InvokeRequired Then
			frmMain.BeginInvoke(New Action(Of String, String, String, String, Boolean)(AddressOf DisplayStringResult), Test, Low, measured, High, Passed)
		Else
			frmMain.DisplayStringResult(Test, Low, measured, High, Passed)
		End If
	End Sub
	'Public Sub RecordPassFail(ByVal Testname As String, ByVal IsPass As Boolean)
	'  If frmMain.InvokeRequired Then
	'    frmMain.Invoke(New Action(Of String, Boolean)(AddressOf RecordPassFailSync), Testname, IsPass)
	'  Else
	'    RecordPassFailSync(Testname, IsPass)
	'  End If
	'End Sub
	Public Sub RecordPassFail(ByVal Testname As String, ByVal IsPass As Boolean)
		Call pResults.RecordPassFail(Testname, IsPass)
		'Call frmMain.DisplayStringResult(Testname, "True", IsPass.ToString, "True", IsPass)
		DisplayStringResult(Testname, "True", IsPass.ToString, "True", IsPass)
		Call Globals_Renamed.MyDoEvents() 'to check abort flag
	End Sub

	Public Sub StartTestGroup(ByVal GroupName As String, Optional ByVal ClearFirst As Boolean = True)
		If frmMain.InvokeRequired Then
			frmMain.Invoke(New Action(Of String, Boolean)(AddressOf StartTestGroupSync), GroupName, ClearFirst)
		Else
			StartTestGroupSync(GroupName, ClearFirst)
		End If
	End Sub
	Public Sub StartTestGroupSync(ByVal GroupName As String, Optional ByVal ClearFirst As Boolean = True)
	...
	'  If frmMain.InvokeRequired Then
	'    frmMain.BeginInvoke(New Action(AddressOf StopTestGroupSync))
	'  Else
	'    StopTestGroupSync()
	'  End If
	'End Function
	Public Function StopTestGroup() As Boolean
		...
		End If
	End Function
	Private Sub SetGroupStatusSync(ByVal TestGroup As String, ByVal Status As Short)
		If frmMain.InvokeRequired Then
			frmMain.BeginInvoke(New Action(Of String, Short)(AddressOf SetGroupStatusSync), TestGroup, Status)
		Else
			frmMain.SetGroupStatus(TestGroup, Status)
		End If
	End Sub
