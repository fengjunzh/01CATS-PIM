Public Class frmDiagLoop
	...
	Dim testStepL As List(Of String)
		...
		Try
			...
			If tmpBarcode = "" Then
				If Not frmMain.GetUUTInfo2() Then
					...
					Exit Sub
				End If
				tmpBarcode = frmMain.TxtBarcode.Text
			Else
				frmMain.TxtBarcode.Text = tmpBarcode
			End If
			...
			Call pResults.StartTest(tmpBarcode, testStep, Common.CelesticaBarcode)
			count = 0
			If runForever Then
				While Not stopTest And Not abortNow
					...
					If Not stopTest And Not abortNow Then
						...
						iterStartTime = Now()
						If TestObj Is Nothing Then
							Common.clsOperator.REvntRunTest(tmpBarcode, testStepL, Cancel)
						Else
							Call TestObj.RunTest(frmMain.TxtBarcode.Text, testStepL, Cancel)
						End If
					End If
				End While
			Else
				While count < runCount And Not stopTest And Not abortNow
					...
					If Not stopTest And Not abortNow Then
						...
						iterStartTime = Now()
						If TestObj Is Nothing Then
							Common.clsOperator.REvntRunTest(frmMain.TxtBarcode.Text, testStepL, Cancel)
						Else
							Call TestObj.RunTest(tmpBarcode, testStepL, Cancel)
						End If
