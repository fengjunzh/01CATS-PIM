...
Public Class RflightDevice
    ...
    Public Function GetRFPower() As Double() Implements IIMDDevice.GetRFPower
        Try
            ...
            CorrectRFPower_TwoPort()

            Dim resp(1) As Double
            resp(0) = GetPortDBM(IIMDDevice.enumRFPORTS.PORTA)
            resp(1) = GetPortDBM(IIMDDevice.enumRFPORTS.PORTB)

            Return resp

        Catch ex As Exception
            Throw New Exception("GetRFPower()::" & ex.Message)
        End Try
    End Function
