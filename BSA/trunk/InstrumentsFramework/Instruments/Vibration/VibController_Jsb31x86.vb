...
Public Class VibController_Jsb31x86
	Inherits Instrument
	...
	Declare Function Jsb31xGetNumberOfModules Lib "Jsb31xX86.dll" () As Short
	Declare Function Jsb31xGetSerialNumber Lib "Jsb31xX86.dll" (ByVal nNum As Integer, ByVal sNum As String, ByVal iSize As Short) As Boolean
	Declare Function Jsb31xGetFirmwareVersion Lib "Jsb31xX86.dll" (ByVal sSerial As String, ByVal sNum As String, ByVal iSize As Short) As Boolean
	Declare Function Jsb31xGetDriverVersion Lib "Jsb31xX86.dll" (ByVal sSerial As String, ByVal sNum As String, ByVal iSize As Short) As Boolean
	Declare Function Jsb31xGetDllVersion Lib "Jsb31xX86.dll" (ByVal sNum As String, ByVal iSize As Short) As Boolean
	Declare Function Jsb31xIsRelayClosed Lib "Jsb31xX86.dll" (ByVal sSerial As String) As Boolean
	Declare Function Jsb31xGetInput Lib "Jsb31xX86.dll" (ByVal sSerial As String) As Short
	Declare Function Jsb31xCloseRelay Lib "Jsb31xX86.dll" (ByVal sSerial As String) As Boolean
	Declare Function Jsb31xOpenRelay Lib "Jsb31xX86.dll" (ByVal sSerial As String) As Boolean
	Declare Function Jsb31xFlashLed Lib "Jsb31xX86.dll" (ByVal sSerial As String) As Boolean



	'Declare Function Jsb31xGetNumberOfModules Lib "Jsb31x.dll" () As Short
	'Declare Function Jsb31xGetSerialNumber Lib "Jsb31x.dll" (ByVal nNum As Integer, ByVal sNum As String, ByVal iSize As Short) As Boolean
	'Declare Function Jsb31xGetFirmwareVersion Lib "Jsb31x.dll" (ByVal sSerial As String, ByVal sNum As String, ByVal iSize As Short) As Boolean
	'Declare Function Jsb31xGetDriverVersion Lib "Jsb31x.dll" (ByVal sSerial As String, ByVal sNum As String, ByVal iSize As Short) As Boolean
	'Declare Function Jsb31xGetDllVersion Lib "Jsb31x.dll" (ByVal sNum As String, ByVal iSize As Short) As Boolean
	'Declare Function Jsb31xIsRelayClosed Lib "Jsb31x.dll" (ByVal sSerial As String) As Boolean
	'Declare Function Jsb31xGetInput Lib "Jsb31x.dll" (ByVal sSerial As String) As Short
	'Declare Function Jsb31xCloseRelay Lib "Jsb31x.dll" (ByVal sSerial As String) As Boolean
	'Declare Function Jsb31xOpenRelay Lib "Jsb31x.dll" (ByVal sSerial As String) As Boolean
	'Declare Function Jsb31xFlashLed Lib "Jsb31x.dll" (ByVal sSerial As String) As Boolean
	...
	Public Function StartVIB() As Boolean Implements IUSB_VIB_CONTROLLER.StartVIB
		...
		End Try
	End Function
	'Public Overrides Sub Close() Implements IUSB_VIB_CONTROLLER.StopVIB
	'  Try
	'    Jsb31xOpenRelay(g_strSerial)
	'  Catch ex As Exception
    ...
    Public Function ReadInput(ByVal InputNo As Integer) As Boolean Implements IUSB_VIB_CONTROLLER.ReadInput
        Try
            ...
            m_abytSL = Jsb31xGetInput(g_strSerial)
