...
<System.Runtime.InteropServices.ProgId("clsOperatorInterface_NET.clsOperatorInterface")> Public Class clsOperatorInterface
    ...
    Public Sub CmdRunAll_Click() ' add by tony 20200313
        frmMain.CmdRunAll.Enabled = True
        frmMain.CmdRunAll.PerformClick()
    End Sub
    ...
    End Sub
    '==========================2019 0228 add by tony
    Public Sub ChamberIDdisplay(ByVal chamberID As String)
        frmMain.ChamberID_display.Visible = True
        frmMain.ChamberID_display.Font = New Font("Arial", "22")
        frmMain.ChamberID_display.ForeColor = Color.Green
        frmMain.ChamberID_display.Text = chamberID
    End Sub

    Public Sub ChamberIDdisplay_Disable()
        frmMain.ChamberID_display.Visible = False
    End Sub

    '=============================Frank============================================
    Public Property connStr() As String
        Get
            Return Common.connstr
        End Get

        Set(ByVal Value As String)
            Common.connstr = Value
        End Set
    End Property

    Public Property CurPCName() As String
        Get
            Return Common.CurPCName
        End Get
        Set(value As String)
            Common.CurPCName = value
        End Set
    End Property
