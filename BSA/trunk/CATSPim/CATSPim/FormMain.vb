...
Public Class FormMain
    ...
    Private Sub InitializeConfigure()
        Try
            ...
            GetfactoryCode(pFactory) '获取工厂代码
    ...
    Private Sub GetfactoryCode(ByVal factory As String)
        Try
            Dim Factorylist1 As List(Of CATS.Model.factory)
            Dim Factorylis2 As New CATS.BLL.factoryManager
            Factorylist1 = Factorylis2.SelectAll()

            For Each mm In Factorylist1
                If mm.name.ToUpper.Trim = factory.ToUpper.Trim Then
                    pFactoryCode = mm.code.ToUpper.Trim
                    pFactoryID = mm.id
                    Return
                End If
            Next
...
#End If
        ...
        '#End If
         ...
         Try
            ...
            Try
                ''  CalibrationRecord.InitializeCal() 'add cal 20180416
